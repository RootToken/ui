...
export interface CurveCryptoFactoryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "batch_set_liquidity_gauges", values: [PromiseOrValue<string>[], PromiseOrValue<string>[]]): string;
...
export declare type PoolAddedEvent = TypedEvent<[string], PoolAddedEventObject>;
...
export interface CurveCryptoFactory extends BaseContract {
    ...
    functions: {
        ...
        get_fees(_pool: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[[BigNumber, BigNumber, BigNumber, BigNumber]]>;
        get_admin_balances(_pool: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber[]]>;
        get_coin_indices(_pool: PromiseOrValue<string>, _from: PromiseOrValue<string>, _to: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        ...
        add_pool(_pool: PromiseOrValue<string>, _n_coins: PromiseOrValue<BigNumberish>, _lp_token: PromiseOrValue<string>, _gauge: PromiseOrValue<string>, _zap: PromiseOrValue<string>, _decimals: PromiseOrValue<BigNumberish>, _name: PromiseOrValue<string>, overrides?: Overrides & {
        ...
        batch_set_liquidity_gauges(_pools: PromiseOrValue<string>[], _liquidity_gauges: PromiseOrValue<string>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        get_coin_swap_count(_coin: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        get_coin_swap_complement(_coin: PromiseOrValue<string>, _index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        add_pool(_pool: PromiseOrValue<string>, _n_coins: PromiseOrValue<BigNumberish>, _lp_token: PromiseOrValue<string>, _gauge: PromiseOrValue<string>, _zap: PromiseOrValue<string>, _decimals: PromiseOrValue<BigNumberish>, _name: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        ...
        batch_set_liquidity_gauges(_pools: PromiseOrValue<string>[], _liquidity_gauges: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<void>;
        address_provider(overrides?: CallOverrides): Promise<string>;
        pool_list(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        pool_count(overrides?: CallOverrides): Promise<BigNumber>;
        coin_count(overrides?: CallOverrides): Promise<BigNumber>;

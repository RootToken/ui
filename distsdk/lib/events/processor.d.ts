...
/** */
export declare const BN: (v: EBN | BigNumber.Value) => BigNumber;
export declare const decimalBN: (v: EBN | BigNumber.Value, decimals: number) => BigNumber;
export declare const tokenBN: (v: EBN | BigNumber.Value, token: Token) => BigNumber;

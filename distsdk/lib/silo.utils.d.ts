...
export declare type CrateSortFn = <T extends Crate<BigNumber>>(crates: T[]) => T[];
/**
 ...
 */
export declare function sortCratesBySeason<T extends Crate<BigNumber>>(crates: T[], direction?: 'asc' | 'desc'): T[];
/**
 * Order crates by BDV.
 */
export declare function sortCratesByBDVRatio<T extends DepositCrate<BigNumber>>(crates: T[], direction?: 'asc' | 'desc'): T[];

...
import { BigNumber as BigNumber$1, utils, Contract, ContractFactory, ethers } from 'ethers';
...
import { formatUnits, commify, parseUnits as parseUnits$1 } from 'ethers/lib/utils';
...
function toBaseUnitBN(decimalAmt, decimals) {
  var amt = new BigNumber(decimalAmt);
...
function toTokenUnitsBN(tokenAmt, decimals) {
  var amt = new BigNumber(tokenAmt.toString());
  var base = new BigNumber(10);
  var decimalsBN = new BigNumber(decimals);
  var digits = base.pow(decimalsBN);
...
var logger = /*#__PURE__*/new Logger('beannumber');
...
var logger$1 = /*#__PURE__*/new Logger('BeanNumber');
var names = ['wei', 'kwei', 'mwei', 'gwei', 'szabo', 'finney', 'ether'];
var zeros$1 = '0';
while (zeros$1.length < 256) {
  zeros$1 += zeros$1;
}
var NegativeOne = /*#__PURE__*/BigNumber$1.from(-1);
 ...
 */
var TESTNET_CHAINS = /*#__PURE__*/new Set([ChainId.LOCALHOST, ChainId.CUJO]);
...
var ZERO_BN = /*#__PURE__*/new BigNumber(0);
...
var bigNumberResult = function bigNumberResult(result) {
  return new BigNumber(result.hasOwnProperty('_hex') ? result.toString() : result);
};
// /**
...
var _Blocks;
var Blocks = (_Blocks = {}, _Blocks[ChainId.MAINNET] = {
...
var EventManager = /*#__PURE__*/function () {
    ...
    var _getSiloEvents = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_account, _token, _fromBlock, _toBlock) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              fromBlockOrGenesis = _fromBlock || Blocks[ChainId.MAINNET].BEANSTALK_GENESIS_BLOCK;
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              fromBlockOrGenesis = _fromBlock || Blocks[ChainId.MAINNET].BEANSTALK_GENESIS_BLOCK;
              fromBlockOrBIP10 = _fromBlock || Blocks[ChainId.MAINNET].BIP10_COMMITTED_BLOCK;
              fromBlockOrFertLaunch = _fromBlock || Blocks[ChainId.MAINNET].FERTILIZER_LAUNCH_BLOCK;
              toBlock = _toBlock || 'latest';
  ...
  _proto.reduceAndSort = function reduceAndSort(events) {
    return flattenDeep(events).reduce(reduceEvent, []).sort(sortEvents);
  };
  return EventManager;
}();
...
var Silo = /*#__PURE__*/function () {
  ...
  _proto._applyDeposit = function _applyDeposit(state, token, rawCrate) {
    var season = new BigNumber$2(rawCrate.season);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              ...
              seasonBN = new BigNumber$2(season);
              _context2.next = 14;
  ...
  _proto.pickCrates = function pickCrates(crates, token, amount, sort) {
    ...
    var seasons = [];
    var amounts = [];
    var remaining = new BigNumber$2(amount);
...
var AddLiquidity = /*#__PURE__*/function (_BaseAction) {
  ...
  function AddLiquidity(_pool, _registry, _amounts, _fromMode, _toMode) {
    var _this;
    if (_fromMode === void 0) {
      _fromMode = FarmFromMode.INTERNAL_TOLERANT;
    }
    if (_toMode === void 0) {
      _toMode = FarmToMode.INTERNAL;
    }
    _this = _BaseAction.call(this) || this;
    _this._pool = void 0;
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              amountInStep = this._amounts.map(function (k) {
                return k === 1 ? _amountInStep : ethers.BigNumber.from(0);
              }); /// Get amount out based on the selected pool
...
var LibraryPresets = function LibraryPresets(sdk) {
  ...
  this.weth2bean = function (fromMode, toMode) {
    return [_this.weth2usdt(fromMode, FarmToMode.INTERNAL), _this.usdt2bean(FarmFromMode.INTERNAL, toMode)];
  };
  this.bean2weth = function (fromMode, toMode) {
    return [_this.bean2usdt(fromMode, FarmToMode.INTERNAL), _this.usdt2weth(FarmFromMode.INTERNAL, toMode)];
  };
};
...
var BeanstalkSDK = /*#__PURE__*/function () {
  ...
  function BeanstalkSDK(config) {
    ...
    // FIXME
    // @ts-ignore
    this.chainId = enumFromValue((_this$provider$networ = (_this$provider = this.provider) == null ? void 0 : (_this$provider$networ2 = _this$provider.network) == null ? void 0 : _this$provider$networ2.chainId) != null ? _this$provider$networ : 1, ChainId);
    this.source = (config == null ? void 0 : config.source) || DataSource.SUBGRAPH;
    // Globals
    this.addresses = addresses;
    this.contracts = new Contracts(this);
    this.tokens = new Tokens$1(this);
    this.graphql = new GraphQLClient((config == null ? void 0 : config.subgraphUrl) || 'https://graph.node.bean.money/subgraphs/name/beanstalk');
...
var DecimalBigNumber = /*#__PURE__*/function () {
  function DecimalBigNumber(value, decimals) {
    ...
    if (typeof value === 'string') {
      ...
      this._value = parseUnits$1(formatted, _decimals);
  ...
  _proto.toString = function toString(_temp) {
    ...
    var result = formatUnits(this._value, this._decimals);
...
export { BeanNumber, BeanstalkSDK, BeanstalkToken, ChainId, DataSource, DecimalBigNumber, ERC20Token, FarmFromMode, FarmToMode, NativeToken, index as Utils };
